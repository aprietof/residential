...
function wpestate_new_general_set() {  
   ...
   /*
    update_option('wp_estate_adv6_taxonomy_terms','');  
    update_option('wp_estate_adv6_taxonomy','');   
    update_option('wp_estate_adv6_min_price','');  
    update_option('wp_estate_adv6_max_price','');  
   */
}
...
function new_wpestate_map_details(){
    ...
    <div class="option_row_explain">'.__('A high number will increase the response time and server load. Use a number that works for your current hosting situation.','wpestate').'</div>    
...
if( !function_exists('new_wpestate_theme_slider') ):   
 function new_wpestate_theme_slider(){
    ...
    <div class="option_row_explain">'.__('Pick the desing type.','wpestate').'</div>    
